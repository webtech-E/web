...
<head>
	...
	<link rel="stylesheet"  href="./../view/find_blood.css">
...
<body>
	...
	<div class="box">
		...
		<a href="https://play.google.com/store/apps/details?id=com.savelife.connect.app" target="_blank"><img class ="pic_playstore"src="./../view/image/Google-Play-Store.jpg" alt="Picture Not Find"></a>
		<a href="https://www.apple.com/store" target="_blank"><img class ="pic_playstore"src="./../view/image/apple app.png" alt="Picture Not Find"></a>
        ...
        <source src="./../view/image/Save Life Connect.mp4" type="video/mp4"> 
		</video> 
