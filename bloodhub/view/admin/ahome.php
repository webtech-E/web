     ...
     <header>
        <div class="container">
                ...
                <ul class="content_nav">
                    <li><a href="#"><img class ="donorpic" src="./../../image/donor.jpg" alt="Donor pic not found">Doner</a></li><br>
                    <li><a href="#">Receiver</a></li><br>
                    <li><a href="#">Search</a></li><br>
                    <li><a href="#">Upadte System</a></li><br>
					<li><a href="#">Modify</a></li><br>
					 <li><a href="../alogout.php"><img class ="logoutpic" src="./../../image/logout.png" alt="Logout pic not found">Logout</a></li><br>
                </ul>
